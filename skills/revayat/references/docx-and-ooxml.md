...
```bash
python3 scripts/revayat.py build --book work/book.json --out out/book.fa.docx [options]
```
...
```bash
python3 scripts/revayat.py qa docx --file out/book.fa.docx --book work/book.json
```
