...
```bash
python3 <skill>/scripts/revayat-novel.py qa check --book ${1:-work}/book.json --assets ${1:-work}/assets --glossary ${1:-work}/glossary.json
python3 <skill>/scripts/revayat-novel.py falint lint --book ${1:-work}/book.json
```
